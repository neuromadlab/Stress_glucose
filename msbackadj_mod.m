function [b, Y] = msbackadj_mod(X,Y,varargin)

% This version of the MSBACKADJ function includes one modification from the
% original one: it outputs the regressed estimated baseline values (b)
% Modified by: María Berjano, 2023
...
if any(isnan(X) | isinf(X))
   error(message('bioinfo:msbackadj:XContainsInfOrNan')) 
end
